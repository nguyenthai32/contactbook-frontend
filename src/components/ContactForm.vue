<template>
<Form @submit="$emit('contact-submit', contactLocal)" :validation-schema="schema">
    ...
    <div class="form-group">
        ...
        <button v-if="contactLocal.id" type="button" class="ml-2 btn btn-danger" @click="$emit('contact-delete', contactLocal.id)">
            Xóa
        </button>
    </div>
</Form>
